      ...
      <>
                ...
                <div className="card-body py-0 px-0 px-sm-3">
                  <div className="row align-items-center">
                    <div className="col-4 col-sm-3 col-xl-2">
                      <img
                          src="../../../Werkstuk_CMSDEV_ParanormaxApp-NielsMoens/paranormax/public/images/dashboard/Group126@2x.png"
                          className="gradient-corona-img img-fluid" alt=""/>
                    </div>
                    <div className="col-5 col-sm-7 col-xl-8 p-0">
                      <h4 className="mb-1 mb-sm-0">Want even more features?</h4>
                      <p className="mb-0 font-weight-normal d-none d-sm-block">Check out our Pro version with 5 unique
                        layouts!</p>
                    </div>
                    <div className="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                    <span>
                      <a href="https://www.bootstrapdash.com/product/corona-admin-template/" target="_blank"
                         className="btn btn-outline-light btn-rounded get-started-btn" rel="noreferrer">Upgrade to PRO</a>
                    </span>
                    </div>
                  </div>
                </div>
        ...
        <footer className="footer">
          <div className="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span className="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Free
